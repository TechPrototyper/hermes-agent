...
# kaniko (in-cluster builds) kann nur oktale --chmod-Werte parsen —
# symbolisches a+rX,go-w bricht den Build (strconv.ParseUint). Daher
# COPY ohne chmod + expliziter RUN-chmod-Pass (~21s amd64, vgl. #49113).
COPY --link . .
